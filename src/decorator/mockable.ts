import {ClassDeclaration, InterfaceDeclaration, isDecorator} from "typescript";
...
export const isMockable = (target: ClassDeclaration | InterfaceDeclaration): boolean => {
    return target.modifiers && target.modifiers.some((modifier) => {
